...
const FromType = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!name.trim()) {
      toast.error(<span className="font-phetsarath">ກະລຸນາປ້ອນຊື່ປະເພດ</span>);
      return;
    }

    setIsLoading(true);
    try {
      const res = await saveType(token, { name });
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 font-notosanslao">
            ເພີ່ມແລະຈັດການຂໍ້ມູນປະເພດລົດໃນລະບົບ
          </p>
        </div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                ...
                <input
                  ...
                  placeholder="ປ້ອນຊື່ປະເພດລົດເຊັ່ນ: (ລົດຄອບຄົວ, ກະບະ, ລົດ4ປະຕູ... )"
                  type="text"
