...
const EditBrand = () => {
  ...
  const fetchBrand = async (id, form) => {
    try {
      const res = await readBrand(id, form);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await updateBrand(token, id, form);
      // console.log(res);
      toast.success(<p className="font-phetsarath">ອັບເດດແບນລົດສຳເລັດ</p>);
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                ...
                <input
                  ...
                  placeholder="ຊື່ແບນລົດ ເຊັ່ນ: (Toyota, BMW, Ford.....)"
                  type="text"
                  maxLength={191}
                  name="name"
                  value={form.name}
